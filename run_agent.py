...
from agent.sanitization import (
    _SURROGATE_RE,
...
# Tool scheduling helpers — extracted to agent.kore.tool_scheduling for the
# Kore refactor. Re-exported here for backward compatibility.
from agent.kore.tool_scheduling import (  # noqa: F401
...
from agent.kore.tool_calls import (
    get_tool_call_id_static as _kore_get_tool_call_id_static,
    sanitize_api_messages as _kore_sanitize_api_messages,
    cap_delegate_task_calls as _kore_cap_delegate_task_calls,
    deduplicate_tool_calls as _kore_deduplicate_tool_calls,
    deterministic_call_id as _kore_deterministic_call_id,
...
from agent.kore.reasoning import (
    ...
    supports_reasoning_extra_body as _kore_supports_reasoning_extra_body,
    github_models_reasoning_extra_body as _kore_github_models_reasoning_extra_body,
...
from agent.kore.url_helpers import (
    ...
    anthropic_prompt_cache_policy as _kore_anthropic_prompt_cache_policy,
)
...
from agent.kore.tool_scheduling import pool_may_recover_from_rate_limit as _pool_may_recover_from_rate_limit
...
class AIAgent:
    ...
    def _resolved_api_call_stale_timeout_base(self) -> tuple[float, bool]:
        return _kore_resolved_api_call_stale_timeout_base(self.provider, self.model)
    ...
    def _anthropic_prompt_cache_policy(
        ...
        *,
        ...
        return _kore_anthropic_prompt_cache_policy(
            provider=(provider if provider is not None else self.provider) or "",
            base_url=base_url if base_url is not None else (self.base_url or ""),
            api_mode=api_mode if api_mode is not None else (self.api_mode or ""),
            model=(model if model is not None else self.model) or "",
        )
    ...
    def _max_tokens_param(self, value: int) -> dict:
        return _kore_max_tokens_param(value, is_direct_openai=self._is_direct_openai_url(), is_azure_openai=self._is_azure_openai_url())
    ...
    def _strip_think_blocks(self, content: str) -> str:
        from agent.kore.think_blocks import strip_think_blocks
    ...
    def _get_tool_call_id_static(tc) -> str:
        return _kore_get_tool_call_id_static(tc)
    ...
    def _sanitize_api_messages(messages):
        return _kore_sanitize_api_messages(messages)

    @staticmethod
    @staticmethod
    def _cap_delegate_task_calls(tool_calls):
        return _kore_cap_delegate_task_calls(tool_calls)
    ...
    def _deterministic_call_id(fn_name, arguments, index=0):
        return _kore_deterministic_call_id(fn_name, arguments, index)

    @staticmethod
    @staticmethod
    def _split_responses_tool_id(raw_id):
        return _kore_split_responses_tool_id(raw_id)
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        return _kore_supports_reasoning_extra_body(self.model, self._base_url_lower)

    def _github_models_reasoning_extra_body(self) -> dict | None:
        return _kore_github_models_reasoning_extra_body(self.model, self.reasoning_config)
    ...
    def _needs_kimi_tool_reasoning(self) -> bool:
        return _kore_needs_kimi_tool_reasoning(self.provider, self.base_url)

    def _needs_deepseek_tool_reasoning(self) -> bool:
        return _kore_needs_deepseek_tool_reasoning(self.provider, self.base_url, self.model)
    ...
    @staticmethod
    def _sanitize_tool_call_arguments(messages, *, logger=None, session_id=None):
        return _kore_sanitize_tool_call_arguments(messages, logger=logger, session_id=session_id)
