...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "procedural knowledge — if you learned a non-obvious workflow, overcame errors "
            "through trial and error, or discovered pitfalls that would waste time next "
            "session, offer to save it as a skill. Do not offer when the task's artifact "
            "is code and the procedure was straightforward (install, configure, subclass). "
            "Most hard tasks don't need skills — the code is the record. "
